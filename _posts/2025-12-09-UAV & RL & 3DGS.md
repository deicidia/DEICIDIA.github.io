...
Cette fois-ci, j'ai tenté un scan à plus grande échelle en filmant l'intégralité de mon appartement, mais l'absence de GPU NVIDIA a provoqué des erreurs. Sous Windows, COLMAP a échoué en raison d'un nombre excessif de features. Sous WSL2, le résultat fut limité : seules 23 images ont été conservées pour l'entraînement sur brush.
