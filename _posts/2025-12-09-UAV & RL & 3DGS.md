...
**Objectif :** Tester le 3DGS pour obtenir une vision claire des contraintes et de la faisabilité du projet. Il est à noter que le choix de la stack technique (RL & 3DGS) est avant tout dicté par mes intérêts personnels et une volonté d'apprentissage, privilégiant l'exploration de nouveaux outils à une optimisation industrielle standard.
...
Voici quelques exemples plus probants que les premiers jets (cf. photo ci-dessus) :
* Exemple de scan en mode vidéo, donc non stabilisé : [voir le scan](/scans/zigoto.html).
* Exemple avec ma bibliothèque : [voir le scan](/scans/fuji.html).
...
En parallèle, j'évalue [COLMAP-Free 3D Gaussian Splatting
